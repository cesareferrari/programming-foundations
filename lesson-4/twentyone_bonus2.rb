...
def first_dealing(deck, dealer_cards, player_cards, total_points)
  2.times do
...
def player_hits(deck, dealer_cards, player_cards, total_points)
  player_cards << deck.pop
  update_total_points(total_points, dealer_cards, player_cards)
...
def dealer_hits(deck, dealer_cards, player_cards, total_points)
  prompt "Dealer hits"
  dealer_cards << deck.pop
  update_total_points(total_points, dealer_cards, player_cards)
...
loop do
  ...
  first_dealing(deck, dealer_cards, player_cards, total_points)
  ...
  loop do
    ...
    if player_turn == 'h'
      player_hits(deck, dealer_cards, player_cards, total_points)
    end
  ...
  loop do
    ...
    dealer_hits(deck, dealer_cards, player_cards, total_points)
  end
